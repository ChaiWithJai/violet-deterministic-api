(function () {
  const model = {"JobID":"local-preview","AppName":"Backend Runtime","Domain":"saas","Plan":"starter","Region":"us-east-1","Deployment":"managed","PrimaryUsers":["admin","operator"],"Workflows":["create_record","approve_record","notify_user"],"Entities":["account","workspace","activity"],"Integrations":["stripe","slack"],"WorkloadCount":9,"FileCount":12,"TerminalCount":6,"ConsoleCount":6};

(function () {
  const model = {"JobID":"local-preview","AppName":"Runtime Test","Domain":"crm","Plan":"enterprise","Region":"us-east-1","Deployment":"managed","PrimaryUsers":["admin"],"Workflows":["create_customer"],"Entities":["account"],"Integrations":["stripe"],"WorkloadCount":7,"FileCount":8,"TerminalCount":6,"ConsoleCount":6};
